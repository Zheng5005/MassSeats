...
public sealed class DomainExceptionHandler : IExceptionHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            ReservationNotFoundException => (StatusCodes.Status404NotFound, "Resource not found"),
            SeatAlreadyReservedException => (StatusCodes.Status409Conflict, "Conflict"),
            InvalidReservationStateException => (StatusCodes.Status409Conflict, "Conflict"),
